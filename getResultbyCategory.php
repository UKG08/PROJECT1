...
{?>
    ...
    <p> <i class="icon ion-md-trophy"></i> <div class="title">Parity Record</div> </p>
        ...
        <tbody>
        <?php
 $parityrecordQuery=mysqli_query($con,"select * from `tbl_result` where `tabtype`='parity' order by id desc limit 720");
 $parityrecordRow=mysqli_num_rows($parityrecordQuery);
 if($parityrecordRow==null){?>
 <tr>
        <td colspan="4">
...
{?>
    ...
    <p> <i class="icon ion-md-trophy"></i> <div class="title">Sapre Record</div> </p>
        ...
        <tbody>
        <?php
 $saprerecordQuery=mysqli_query($con,"select * from `tbl_result` where `tabtype`='sapre' order by id desc limit 720");
 $saprerecordRow=mysqli_num_rows($saprerecordQuery);
 if($saprerecordRow==null){?>
 <tr>
        <td colspan="4">
        <div style="display: flex;">
        <div class="spacer"></div>
...
<div class="containerrecord text-center">
    ...
    <p> <i class="icon ion-md-trophy"></i> <div class="title">Bcone Record</div> </p>
        ...
        <tbody>
        <?php
 $bconerecordQuery=mysqli_query($con,"select * from `tbl_result` where `tabtype`='bcone' order by id desc limit 720");
 $bconerecordRow=mysqli_num_rows($bconerecordQuery);
 if($bconerecordRow==null){?>
 <tr>
        <td colspan="4">
        <div style="display: flex;">
        <div class="spacer"></div>
...
<?php
 ...
 ?>
    ...
    <p> <i class="icon ion-md-trophy"></i> <div class="title">Emerd Record</div> </p>
        ...
        <tbody>
        <?php
 $emerdrecordQuery=mysqli_query($con,"select * from `tbl_result` where `tabtype`='emerd' order by id desc limit 720");
 $emerdrecordRow=mysqli_num_rows($emerdrecordQuery);
 if($emerdrecordRow==null){?>
 <tr>
        <td colspan="4">
        <div style="display: flex;">
        <div class="spacer"></div>
