...
<div class="container">
    <ul class="nav nav-tabs">
        ...
        <li><a data-toggle="tab" href="#menu1">Tele_Pay</a></li>
    </ul>
...
<div class="tab-content">
  ...
  <div id="menu1" class="tab-pane fade">    
        <h1><b>Step 1. <br>Click on Tele_Pay</b></h1>
        <div class="box" style="margin-bottom: 0;">

      <a class="badge badge-success center-badge" style="display: flex; justify-content: center; align-items: center; background-color: limegreen; font-size:55px;" href="https://telegram.me/WinGo2021_bot">Tele_Pay</a>
        </p>
        </div>    
  </div>
</div>
<div>
<h1><b>Step 2.<br>Transfer the amount to the UPI account Given on Telegram </b></h1>
</div>
