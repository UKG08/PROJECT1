...
<!-- App Header -->
<div class="appHeader1" style="background-color:dodgerblue !important">
...
if($chkwithdrawalResult['status']==0){
          ...
          <div class="image">
            ...
            <div class="text "><div><strong class="text-success">WithdrawalSuccess</strong> 
            
       <p class="text-primary" style="font-size:12px;">
      To: <?php echo user($con,'mobile',$userid);?>
      
      
      
      </p>
      <small><?php echo $convert;?></small></div></div>
            </div>
            </td>
          <td class="tdtext text-suc">
            
            <?php echo number_format($summeryResult['amount'],2);?>
            </strong>
          ...
          <small class="text"><?php echo $convert;?></small>
        ...
        <tr>
          ...
          <div class="image">
            ...
            <div class="text "><div><strong class="text-warning">WithdrawalPending</strong> 
...
<small>Pending..</small></td>
     ...
     <div class="text text-danger"><div><strong style="font-size:14px; color:red;">WithdrawalFailed </strong><small><?php echo $convert;?></small></div></div>
            </div>
            </td>
          <td class="tdtext2 text-danger">+<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
        <?php }?>
