...
<div class="vcard"> 
  <div class="appContent3 text-white">
    <div class="row">
     ...
     <div class="col-12">
     <a href="recharge.php" class="btn btn-sm btn-success pull-left m-0" style="background-color:limegreen !important">Recharge</a> 
      </div>
    </div>
  </div>
</div>
...
<div class="card-header">
            <h2 class="mb-0"> 
             <a href="WinGo.apk" class="btn btn-link collapsed"><i class="fa fa-download text-primary" style="font-size:16px"></i>
           Download App </a> </h2>
          </div>
<p style="color: white; font-size:11px;" ><strong>_____________________________________________________________________</p>
<div class="card-header" id="headingThree">
          <h2 class="mb-0"> <a href="#" class="btn btn-link collapsed fa fa-telegram text-primary" type="button" data-toggle="collapse" data-target="#collapsesix" aria-expanded="false" aria-controls="collapsesix"> Support </a> </h2>
        </div>
        <div id="collapsesix" class="collapse">
        <a href="https://telegram.me/WinGo2021_bot" class="sub-link"> Telegram </a>
        <a href="mailto:support@wingo2021.site" class="sub-link"> Email = support@wingo2021.site </a>
         </div>
<p style="color: white; font-size:11px;" ><strong>_____________________________________________________________________</p>
         </div>
      <!-- * listview --> 
   ...
   <!-- app Footer -->
  <div class="text-center mt-4"> <a href="logout.php" class="btn btn-sm btn-light" style="width:200px; background-color:LightSlateGrey;">Logout</a> </div>
  <!-- * app Footer --> 
