...
<!-- App Header -->
<div class="vcard" >
  <div class="appContent3 text-white" style="background-color:dodgerblue !important">
    <div class="row">
      <div class="col-12">
        ...
        <div class="col-12">
          <div> <a href="recharge.php" class="btn btn-blue btn-blue m-0" style="background-color:limegreen !important">Recharge</a> <a  data-toggle="modal" href="#rule" data-backdrop="static" data-keyboard="false" class="btn btn-green btn-green" style="background-color:green !important">Read Rule</a> <a href="javascript:void(0);" onClick="reloadbtn(<?php echo $userid;?>);" class="reaload text-white pull-right mt-1" onclick="getResultbyCategory(parity,parity)"> <i class="icon ion-md-refresh"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<a class="nav-link" id="contact-tab3" data-toggle="tab" href="#emerd" role="tab" onClick="tabname('emerd');getResultbyCategory('emerd','emerd');">Emerd</a> 
      ...
      <div class="divsize4">
      <button type="button"  class="btn btn-lg btn-success gbutton none" style="background-color: limegreen;" onClick="betbutton('#1DCC70','button','Green');">Join Green</button>
      </div>
      <div class="divsize4">
     ...
     <div cla="container-fluid  ">
      ...
      <div class="divsize2">
      <button type="button" class="btn btn-lg gbutton none btn-blue" style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(229, 77, 66) 50%);" onClick="betbutton('#18FFFF','button','0');">0</button>
      </div>
      <div class="divsize2">
      <button type="numbutton" class="btn btn-lg btn-blue gbutton none" style="background-color: limegreen;" onClick="betbutton('#18FFFF','button','1');">1</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-color: red;" onClick="betbutton('#18FFFF','button','2');">2</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-color: limegreen;" onClick="betbutton('#18FFFF','button','3');">3</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-color: red;" onClick="betbutton('#18FFFF','button','4');">4</button>
      </div>
      ...
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-image: linear-gradient(160deg, rgb(103, 57, 182) 50%, rgb(57, 181, 74) 50%);" onClick="betbutton('#18FFFF','button','5');">5 </button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-color: red;" onClick="betbutton('#18FFFF','button','6');"> 6</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-color: limegreen;" onClick="betbutton('#18FFFF','button','7');">7 </button>
      </div>
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-color: red;" onClick="betbutton('#18FFFF','button','8');"> 8</button>
      </div>
      <div class="divsize2">
      <button type="button" class="btn btn-lg btn-blue gbutton none" style="background-color: limegreen;" onClick="betbutton('#18FFFF','button','9');">9 </button>
      </div>
      </div>
...
<div id="rule" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content ">
      <div class="modal-header" style="background-color:limegreen !important"> </div>
...
var countDownDate = Date.parse(new Date) / 1e3;
  ...
  var distance = 120 - countDownDate % 120;
  //alert(distance);
  var i = distance / 60,
   n = distance % 60,
   o = n / 10,
...
if(distance==120 || distance==115 || distance==110 || distance==105 || distance==100){
generateGameid();
getResultbyCategory('parity','parity');
